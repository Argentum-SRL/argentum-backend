...
# Galicia de usuario5 y su réplica testingadmin tienen saldo_inicial en 0
...
SALDOS_REFERENCIA_21 = {
    ...
    ("usuario4@argentum.test", "Efectivo ARS"): Decimal("-30060.00"),
    ...
    ("usuario5@argentum.test", "Galicia"): Decimal("1311289.73"),
