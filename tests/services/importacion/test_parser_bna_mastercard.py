...
def test_sanitizar_texto_pdf():
    ...
    """
    texto_simulado = """GOMEZ CARLOS ALBERTO HOJA 1/4
AV SAN MARTIN 450
CUIT Entidad 30-71234567-9
...
"""
    ...
    assert "AV SAN MARTIN 450" not in texto_sanitizado
...
def test_parsear_bna_mastercard_with_mock():
    ...
    """
    pdf_text_simulado = """GOMEZ CARLOS ALBERTO HOJA 1/4
AV SAN MARTIN 450
CUIT Entidad 30-71234567-9
01425 CAPITAL FEDERAL MASTERCARD BLACK
N° de Socio 099-0123456-0-1
...
"""
        ...
        "transacciones": [
            {
                ...
                "titular_seccion": "GOMEZ CARLOS ALBERTO"
            },
            {
                "fecha": "2026-05-19",
    ...
    with patch("pdfplumber.open", return_value=mock_pdf), \
        ...
        assert "AV SAN MARTIN 450" not in user_content
        assert "30-71234567-9" not in user_content
        assert "099-0123456-0-1" not in user_content
        ...
        assert res.banco == "bna_mastercard"
        assert res.titular_detectado == "GOMEZ CARLOS ALBERTO"
