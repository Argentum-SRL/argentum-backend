...
from sqlalchemy import Boolean, Date, DateTime, Enum as SAEnum, ForeignKey, Integer, Numeric, String, Index
...
class GrupoCuotas(Base):
    ...
    __table_args__ = (
        Index("ix_grupos_cuotas_tarjeta_usuario", "tarjeta_id", "usuario_id"),
    )
