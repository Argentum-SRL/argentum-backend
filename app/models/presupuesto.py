...
from sqlalchemy import DateTime, Enum as SAEnum, ForeignKey, Numeric, String, Index
...
class Presupuesto(Base):
    ...
    __table_args__ = (
        Index("ix_presupuestos_usuario_id", "usuario_id"),
        Index("ix_presupuestos_estado", "estado"),
    )
