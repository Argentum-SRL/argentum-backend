...
class TarjetaCredito(Base):
    ...
    limite_credito: Mapped[float | None] = mapped_column(Numeric(15, 2), nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<TarjetaCredito(id={self.id!r}, nombre={self.nombre!r}, red={self.red.value!r})>"
